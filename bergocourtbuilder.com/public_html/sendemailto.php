...
$country    = "";
$dataFromApplication    = @trim(stripslashes($_POST['dataFromCourt2']));
...
$mail->Username = 'design@bergocourtbuilder.com';                 // SMTP username
$mail->Password = 'Send2Mail!';
 
$mail->setFrom('design@bergocourtbuilder.com', 'Bergo Court Builder'); 
$mail->addAddress($email);
$mail->Subject  = "$name want to share with you this sport court";
$mail->Body     = "Name: $name\n".
    "Message:\n $message\n\n".
	"Link: $linkToCourt\n";
$mail->WordWrap = 50;
